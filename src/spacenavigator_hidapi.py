    ...
    def read(self):
        ...
        for name, spec in self.mappings.items():
            if spec.channel == report_id:
                raw = int.from_bytes([data[spec.byte1], data[spec.byte2]], byteorder='little', signed=True)
...
device_spec = DeviceSpec(
    ...
    button_mapping=[
        ButtonSpec(3, 1, 7),  # ALT
        ButtonSpec(3, 1, 6),  # ESC
        ButtonSpec(3, 1, 5),  # F
        ButtonSpec(3, 1, 4),  # R
        ButtonSpec(3, 1, 3),  # L
        ButtonSpec(3, 1, 2),  # T
        ...
        ButtonSpec(3, 2, 5),  # -
        ButtonSpec(3, 2, 4),  # +
        ButtonSpec(3, 2, 3),  # PANEL
        ButtonSpec(3, 2, 2),  # FIT
        ButtonSpec(3, 2, 1),  # CTRL
        ButtonSpec(3, 2, 0),  # SHIFT
    ]
)
